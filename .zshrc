...
# Path to your oh-my-zsh installation.
  export ZSH=/home/unix-like/.oh-my-zsh
...
#
##右提示符样式
#POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status command_execution_time time background_jobs ram battery virtualenv rbenv rvm)
#
##系统图标背景色
...
zsh_wifi_signal(){
    local signal=$(nmcli device wifi | grep '^*' | grep -v SSID | awk '{print $7}')
    local color="yellow"
...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status command_execution_time time background_jobs custom_wifi_signal battery virtualenv rbenv rvm)
